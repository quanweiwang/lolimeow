        ...
        <div class="row align-items-center justify-content-md-between">
            ...
            <div class="col-md-12">
                <div class="copyright text-center">
                    ...
                    . Theme by <a href="https://mkm.st" target="_blank">LoLiMeow</a>
                    &nbsp;<?php echo meowdata('footer_info') ?>
                    <div <?php if (meowdata('trackcodehidden')) echo 'style="display:none;"' ?>><?php echo meowdata('trackcode') ?>
                    </div>
                    <div>
