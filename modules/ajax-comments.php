...
<div <?php comment_class(empty($args['has_children']) ? '' : 'parent'); ?> id="comment-<?php comment_ID(); ?>">
    ...
    <div class="comment-body">
        <div class="meta-data">
            <span class="comment-author"><a href="<?php echo esc_url(get_comment_author_url($comment)); ?>"
                                            rel="external nofollow"
                                            target="_black"><?php comment_author(); ?></a> <?php if ($comment->user_id == 1) {
                    echo '<span class="badge badge-warning  text-uppercase"><i class="fa fa-check-square"></i> '.meowdata('comnanes').'</span>';
                } ?></span></span>
