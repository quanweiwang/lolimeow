...
<div id="respond">
    <form id="commentform" name="commentform" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php"
          method="post">
            ...
            <div class="row justify-content-center mb10">
                <div class="col-md-12">
                    <div class="alert alert-success">
                        <?php printf(__('你好，%s，'), $comment_author); ?><a href="javascript:toggleCommentAuthorInfo();"
                                                                          id="toggle-comment-author-info">[ 切换评论身份 ]</a>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <input type="text" name="new_field_qq" id="qq" class="form-control"
                           value="<?php echo $comment_author; ?>" placeholder="<?php echo __('QQ(自动获取昵称)', 'meowdata') ?>"
                           tabindex="1">
                </div>
            </div><!-- Col 3 end -->
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <input type="email" name="email" id="email" class="form-control"
                           ...
                           placeholder="<?php echo __('邮箱 *', 'meowdata') ?>" tabindex="2"/>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <textarea class="form-control  required-field" rows="5" name="comment" id="comment" tabindex="4"
                              placeholder="你可以在这里输入评论内容..."></textarea>
                </div>
            </div><!-- Col 12 end -->
        </div><!-- Form row end -->
        <div class="clearfix text-center">
            ...
            <button class="btn btn-1 btn-outline-success" name="submit" type="submit" id="submit" tabindex="5">发表评论
            </button>
        </div>
    </form>
